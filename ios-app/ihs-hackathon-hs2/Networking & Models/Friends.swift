    ...
    static func getFriendsHallOfFame( startDate: Date, endDate: Date, category: String, completion: @escaping (_ session: [Friend]) -> Void  ) {
        ...
        let friends =
            [
                ...
                Friend(avatarURL: "https://raw.githubusercontent.com/Ashwinvalento/cartoon-avatar/master/lib/images/male/43.png", fullname: "Kamila Hućko", bestIn: "Push-Ups", value: 921),
                ...
                Friend(avatarURL: "https://raw.githubusercontent.com/Ashwinvalento/cartoon-avatar/master/lib/images/male/49.png", fullname: "Ewa Ninistko", bestIn: "Running", value: 252)
        ]
